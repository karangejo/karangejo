...
function Code() {
  return (
    <Layout
      boatImage={Boat}
      imageWidth="40vw"
      borderRight={<CelticRight alignItems="flex-start" />}
      borderLeft={<CelticLeft alignItems="flex-end" />}
    >
      <Grid
        container
        direction="column"
      ...
      >
        ...
        <Grid item>
          <h2 align="center">
            Please visit my <a href="https://github.com/karangejo">Github</a>{" "}
            page to see all of my projects. <br />
            For all of you who live in Taiwan and surf, windsurf or kitesurf.
            You can check out my site{" "}
            <a href="https://taiwanbuoys.com">Taiwan Buoys.</a>
          </h2>
        </Grid>
      </Grid>
    </Layout>
